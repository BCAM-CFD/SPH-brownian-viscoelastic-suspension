...
9999    CONTINUE
      ...
      !******* Added by Adolfo ********
      SUBROUTINE colloid_set_bounce_back(this,bounce_back,stat_info)
        !----------------------------------------------------
        ! Set the adaptive tolerance of sweep for pairwise implicit
        ! splitting scheme.
        !---------------------------------------------------
        ...
        TYPE(Colloid), INTENT(INOUT)    :: this
        REAL(MK), INTENT(IN)            :: bounce_back
        INTEGER, INTENT(OUT)            :: stat_info

        stat_info = 0

        this%bounce_back = bounce_back
        
        RETURN
        
      END SUBROUTINE colloid_set_bounce_back
      !********************************************
...
9999    CONTINUE
      ...
      !************* Added by Adolfo ****
      SUBROUTINE colloid_set_cc_quad_k(this,d_quad_k,stat_info)
         !----------------------------------------------------
        ! Strength of the quadratic potential 
        !----------------------------------------------------
        
        TYPE(Colloid), INTENT(INOUT)    :: this
        REAL(MK), INTENT(IN)            :: d_quad_k
        INTEGER, INTENT(OUT)            :: stat_info
        
        stat_info = 0
        
        this%cc_quad_k = d_quad_k
        
        RETURN
        
      END SUBROUTINE colloid_set_cc_quad_k
      !**********************************************************

      !************* Added by Adolfo ****
      SUBROUTINE colloid_set_cc_quad_r0(this,d_quad_r0,stat_info)
         !----------------------------------------------------
        ! Strength of the quadratic potential 
        !----------------------------------------------------
        
        TYPE(Colloid), INTENT(INOUT)    :: this
        REAL(MK), INTENT(IN)            :: d_quad_r0
        INTEGER, INTENT(OUT)            :: stat_info
        
        stat_info = 0
        
        this%cc_quad_r0 = d_quad_r0
        
        RETURN
        
      END SUBROUTINE colloid_set_cc_quad_r0
      !**********************************************************      
